          ...
          <table className="border-collapse border border-black mx-auto">
            <thead>
              <tr>
                ...
                <th className="border bg-blue-950 text-white px-4 py-2">Total days</th>
                <th className="border bg-blue-950 text-white px-4 py-2">Present</th>
                <th className="border bg-blue-950 text-white px-4 py-2">Absent</th>
              </tr>
            </thead>
            <tbody>
              {visibleAttendance.map((item) => (
                item.subjects.map((subject, index) => (
                  <tr key={index}>
                    <td className="border border-black px-4 py-2">{item.semesterNumber}</td>
                    <td className="border border-black px-4 py-2">{subject.subjectName}</td>
                    <td className="border border-black px-4 py-2">{subject.Totalclasses}</td>
                    <td className="border border-black px-4 py-2">{subject.Daypresent}</td>
                    <td className="border border-black px-4 py-2">{subject.DayAbsent}</td>
                  </tr>
                ))
              ))}
            </tbody>
