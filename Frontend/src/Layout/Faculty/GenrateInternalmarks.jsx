...
const subjectOptions = [
  { value: 'MISAC1', label: 'MISAC 1' },
  { value: 'MISAC2', label: 'MISAC 2' },
];
...
const GenrateInternalmarks  = () => {
  const regNumbers = generateRegNumbers(5);
  const [selectedSubjects, setSelectedSubjects] = useState(initializeSelectedSubjects(5, subjectOptions.length));
      ...
      <div className='border-2 px-10 py-5 h-auto h-60vh w-auto overflow-hidden rounded-md border-sky-500 flex flex-col justify-center items-center m-10'>
        <div className='overflow-hidden block'>
          <form action="#">
            ...
            <button
                className="bg-blue-500 rounded-md w-20 h-auto text-white text-lg" onClick={goToPreviousPage}>
                Save
              </button>
              <button
