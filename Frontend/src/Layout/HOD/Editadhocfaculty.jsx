...
import Regbackhod from "../../Components/HOD/Regbackhod";

const Editadhocfaculty = () => {
  ...
  const handleupdatedetails = async (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      try {
        // alert("Data saved");
        // Make a POST request to the backend API endpoint for login
        const facultyupdatedresponse = await axios.patch(
        ...
        // Check if the request was successful (status code 2xx)
        if (facultyupdatedresponse.status >= 200 && facultyupdatedresponse.status < 300) {
          ...
          // Handle errors from the backend
          const responseData = facultyupdatedresponse.data;
          setErrors(responseData.errors || {});
        }
      } catch (error) {
          ...
          >
            ...
            <div className="grid md:grid-cols-1 lg:grid-cols-2 md:gap-4 sm:grid-cols-1 sm:gap-2 mt-8">
              ...
              <div className="flex flex-col">
                ...
                <select
                  className="py-1 px-10 border border-gray-700"
                  name="designation"
...
export default Editadhocfaculty;